...
#include "rezi/pairing/GetCommissionerNodeIdCommand.h"
#include "rezi/pairing/GetCommissionerRootCertificateCommand.h"
#include "rezi/pairing/IssueNOCChainCommand.h"
#include "rezi/pairing/OpenCommissioningWindowCommand.h"
#include "rezi/pairing/PairingCommand.h"

#include <app/server/Dnssd.h>
#include <rezi/common/CredentialIssuerCommands.h>
...
{
public:
    PairOnNetwork(CredentialIssuerCommands * credsIssuerConfig, NodeId nodeId, uint32_t pairingCode) : 
        PairingCommand("onnetwork", PairingMode::OnNetwork, PairingNetworkType::None, nodeId, pairingCode, credsIssuerConfig)
    {}
};
